...
HD_PWD='C:/Users/mauro/Desktop/LAB1-KittCar/LAB1-KittCar.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log KittCar_entity.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source KittCar_entity.tcl
